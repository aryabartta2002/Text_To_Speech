...
Label(Top_frame,text="TEXT TO SPEECH",font='arial 20 bold',bg='white',fg='black').place(x=310,y=30)
...
# btn=Button(root,text="Speak",compound=LEFT,image=imageicon,widt=130,font='arial 14 bold')
...
# save=Button(root,text="Speak",compound=LEFT,image=imageicon2,widt=130,font='arial 14 bold')

save=Button(root,text="Save",compound=LEFT,width=10,font='arial 14 bold',command=download)
